...
class Authentication:
    ...
    def gettgt(self):
        ...
        # looks similar to https://utslogin.nlm.nih.gov/cas/v1/tickets/
        # TGT-36471-aYqNLN2rFIJPXKzxwdTNC5ZT7z3B3cTAKfSc5ndHQcUxeaDOLN-cas
